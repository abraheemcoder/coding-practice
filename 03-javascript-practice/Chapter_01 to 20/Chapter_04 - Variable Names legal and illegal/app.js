...
// Q2
// Write 5 legal & 5 illegal variable names.
...
const rulesTitle = "Rules for naming JS variable:";
const allowedCharacters = "Variable names can only contain \nletters, numbers, $ and _.\nFor example: $my_1stVariable.";
const startingRules = "Variables must begin with a \nletter, $ or _.\nFor example: $user, _user or user.";
const caseSensitivity = "Variable names are \ncase sensitive.";
const reservedKeywords = "Variable names should not be \nJS keywords.";
